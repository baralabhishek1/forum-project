...
<body>
    ...
    <div class="container text-center " id="ques">
        <h1 class="my-3">i-Discuss -Browse Categories</h1>

        <div class="row">
            <?php
            // Fetch all the categories and use a loop to iterate through the categories
              ...
              <div class="col-md-4 my-2">
                  <div class="card" style="width: 18rem;">
                      ...
                      <div class="card-body">
                          ...
                          <p class="card-text">'. substr($desc, 0, 100).'...
                              </p>
