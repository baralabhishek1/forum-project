...
echo '<nav class="navbar navbar-expand-lg " style="background-color: #fff;">
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  ...
  if(isset($_SESSION['loggedin']) && ($_SESSION['loggedin'])== true){
    ...
    <button class="btn btn-outline-danger"><a href="partials/_logout.php">
      Logout
      </a>
    </button>
    </form> 
    ...
    echo '<form class="form-inline my-2 my-lg-0" >
        ...
        <button class="btn btn-outline-success mx-2" data-toggle="modal" data-target="#loginModal">
            Login 
        </button>
